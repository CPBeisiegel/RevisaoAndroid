...
import com.example.revisao.views.fragment.ImagemBandaFragment;
...
import com.example.revisao.views.fragment.ListaMusicaFragment;
...
public class HomeActivity extends AppCompatActivity implements Comunicador {
    ...
    public static final String BANDA_TK = "banda";
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.nav_music) {
                    ...
                    replaceFragment(new ListaMusicaFragment());
                }
    ...
    public void recebeMensagem(String mensagem) {
        ...
        bundle.putString(BANDA_TK, mensagem);

        Fragment imagemFragment = new ImagemBandaFragment();
